...
function loadHome() {
  ...
  welcome.innerHTML =
    "Let us treat you to a fine-dining experience you'll never forget";
  ...
  list1.innerHTML = "Fresh, delicious ingredients";
  list.appendChild(list1);
  const list2 = document.createElement("li");
  list2.innerHTML = "Every dish made to order";
  list.appendChild(list2);
  const list3 = document.createElement("li");
  list3.innerHTML = "Exceptional food safety standards";
  list.appendChild(list3);
  const list4 = document.createElement("li");
  list4.innerHTML = "Award-winning service";
  list.appendChild(list4);
  const list5 = document.createElement("li");
  list5.innerHTML = "Inviting style and ambiance";
